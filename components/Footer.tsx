      ...
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-500 max-w-sm leading-relaxed">
              CoreNav is an autonomous tech startup pioneering the next generation of aerial robotics. 
              Engineering excellence from India, delivering high-performance tools for creators across the globe.
            </p>
          </div>

          <div>
            <h4 className="text-white font-bold uppercase tracking-widest text-xs mb-6">Explore</h4>
            <ul className="space-y-4 text-gray-500 text-sm uppercase font-bold tracking-wider">
              <li><button onClick={() => onNavigate?.('home')} className="hover:text-yellow-500 transition-colors">Vau Air Pro</button></li>
              <li><button onClick={() => onNavigate?.('services')} className="hover:text-yellow-500 transition-colors">Core Services</button></li>
              <li><button onClick={() => onNavigate?.('tracking')} className="hover:text-yellow-500 transition-colors">Live Tracking</button></li>
              <li><button onClick={() => onNavigate?.('enterprise')} className="hover:text-yellow-500 transition-colors">Enterprise Division</button></li>
            </ul>
          </div>
        ...
        <div className="pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-6">
          <p className="text-gray-600 text-xs font-mono">
            &copy; 2024 CORENAV PVT LTD. ALL SYSTEMS OPERATIONAL.
          </p>
          <div className="flex items-center space-x-4">
             <span className="text-yellow-500 font-bold uppercase tracking-widest text-[10px]">Made in India for the World</span>
